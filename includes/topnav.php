                ...
                <li class="pull-right">
                    <ul class="hi-menu">
                        <li class="hidden-xs ma-trigger" data-ma-action="sidebar-open" data-ma-target="#chat">
                                <a href=""><i class="him-icon zmdi zmdi-home"></i></a>
                            </li>
                          <li data-ma-action="search-open">
                            <a data-toggle="modal" href="#modalNarrower"><span class="him-label">CHANGE TERM</span></a>
                        </li>
                        <li> <a href=""><span class="text-capitalize"><img src="img/profile-pics/thumb_ferolino.jpg" class="lgi-img">Heubert Ferolino</span></a></li>
                        <li class="dropdown">
